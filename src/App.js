  ...
  "cacheAndPlay": {
    "streamTypes": [
      "usenet"
        ...
        const content = inputDebridio ? contentWithDebridio : contentWithoutDebridio;
        ...
        <div className={`app-container ${fadeIn ? "fade-in" : ""}`}>
            <header className="header">
                ...
                <p className="description">
                    Generate an AIO config, with TorBox and Debridio, in seconds!
                </p>
            </header>
            ...
            <main className="content">
                <div className="section slide-up torbox">
                    ...
                    <div className="section-details">
                        <p>Sign up <a href="https://torbox.app/" target="_blank" rel="noreferrer">here</a>.</p>
                        <div className="tb-referral-message-container">
                            <div className="tb-referral-message-icon">🔥</div>
                            <p className="tb-referral-message">After signing up, <a href="https://torbox.app/subscription?referral=5f3d633a-d6ad-44bf-9b31-488b9340b098" target="_blank" rel="noreferrer">click here</a> to get <b>7 free days added to your account</b><br/>every time you make a purchase!</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="section slide-up info" style={{ animationDelay: "0.6s" }}>
                    <h2>How To Use</h2>
                    ...
                    <div className="section-step">
                        ...
                        <p>Optionally (but highly recommended): save the UUID, so you can access<br/> and modify your configuration later.</p>
                    </div>
                    <div className="section-step">
                        <p>Install the add-on.</p>
                    </div>
                </div>
                <div className="footer">👉🏼  Webiste developed by Comfortable.Debt in 2025</div>
            </main>
        </div>
    );
}
